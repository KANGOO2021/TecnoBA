...
<body>
    <!-- barra de navegación -->
    <header>
        <nav class="navbar navbar-expand-md bg-body-tertiary bg-dark border-bottom border-body fixed-top" data-bs-theme="dark">
            <div class="container-fluid row">
                <div class="col-sm-2 col-md-2 col-3">
                    <a class="navbar-brand" href="#">
                        <img class="icon_codo" src="assets/portada/codo_a_codo.png" title="TiendaBA">
                    </a>
                </div>
                ...
                <div class="col-sm-1 col-md-1 col-1 ms-2 text-end">
                    <a href="carrito.jsp" id="disabled">
                        <i id="carrito" class="fa-solid fa-cart-shopping fa-xl" style="color: #e4dc07;"></i>
                        <span id="cuenta-carrito" class="position-absolute top-25 start-75 translate-middle badge rounded-pill bg-danger count-product">0</span>
                    </a>
                </div>

                <div class="collapse navbar-collapse col-sm-1 col-md-7 col-2 justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                   
                    	<li class="nav-item me-2">
                            <a class="nav-link active btn btn-danger" aria-current="page" href="stock.jsp">Stock</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#nproductos">Productos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#novedades">Novedades</a>
                        </li>
                        <li class="nav-item">
            ...
            <div id="carouselExampleCaptions" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/portada/laptops_portada.jpeg" class="d-block w-100 rounded" alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="assets/portada/celulares_portada.jpg" class="d-block w-100 rounded" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Celulares</h5>
                    ...
                    <div class="carousel-item">
                        <img src="assets/portada/smart_portada.jpeg" class="d-block w-100 rounded" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Smart tv</h5>
            ...
            <div class="container-products" id="container-products">
                <div class="cart-products mb-4" id="products-id">
                    ...
                    <div class="d-flex justify-content-center align-items-center my-3">
                        <h2 class="mx-2">Total: $<strong class="price-total">0</strong></h2>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Ir a pagar</button>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content modal-carrito" id="comprado">
                                    ...
                                    <div class="div-descuentos">
                                        ...
                                        <img  class="img-descuentos" src="assets/comprar/bancociudad.png" alt="">
                                        <p>Descuento del 10%</p>
                                        </div>
                                        <div class="descuentos" onclick="descuentos('0.15')">
                                        <img class="img-descuentos" src="assets/comprar/bancogalicia.png" alt="">
                                        <p>Descuento del 15%</p>
                                        </div>
                                        <div class="descuentos" onclick="descuentos('0.21')">
                                        <img class="img-descuentos" src="assets/comprar/bancoprovincia.png" alt="">
                                        <p>Descuento del 21%</p>
                                        </div>
                                    </div>
                                    <div class="div-precios">
                                        <h3 class="m-2">Subtotal: $<strong id="price-descuentos">0</strong></h3>
                                        <div>
                                            <select class="form-select" id="seleccion" name="seleccion" onclick="precioFinal()" onchange="precioFinal()">
                                            ...
                                            <img class="envios-gratis my-4" src="assets/productos/descarga.jpeg" alt="">
                                            <h2 class="mx-2">Precio Total: $<strong id="price-final">0</strong></h2>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="volver()">Volver</button>
                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="comprar()" >Finalizar compra</button>
                ...
                for (Articulos e : lista) {
                    ...
                    <div class="col-xl-2 col-sm-3">
                        <div class="card" id="card">
                            <div class="card-body">
                                <img src="<%=e.getImagen()%>" class="card-img-top img-productos" alt="">
                                <h5 class="card-title title texto-producto" style="display: -webkit-box;
-webkit-line-clamp: 3;
-webkit-box-orient: vertical;
overflow: hidden;
text-overflow: ellipsis;"><%=e.getDescripcion()%></h5>
                                <p class="precio text-center">$<span class="valor"><%=e.getPrecio()%></span></p>
                                <a href="#" class="btn btn-dark btn-add-cart boton-producto" data-id="<%=e.getIdProducto()%>">Añadir al carrito</a>
            ...
            <div class="container text-center my-3 productos_cel" id="products_cel">
                ...
                for (Articulos e : lista) {
                        ...
                        <div class="carousel-item" id="carrousel-cel">
                            <div class="card" id="card">
                                <div class="card-body">
                                    <img src="<%=e.getImagen()%>" class="card-img-top" id="card-img-top" alt="">
                                    <h5 class="card-title title"><%=e.getDescripcion()%></h5>
                                    <p class="precio text-center">$<span class="valor"><%=e.getPrecio()%></span></p>
                                    <a href="#" class="btn btn-dark small btn-add-cart" data-id="<%=e.getIdProducto()%>">Añadir al carrito</a>
                                </div>
                            </div>
                        </div>
                    <%
        ...
        <section class="novedades text-center" id="novedades">
            <div>
                <h1 class="t-destacados" data-aos="zoom-in">Productos destacados</h1>
            </div>
            <div class="d-destacados">

                <div class="card shadow p-3 mb-3 rounded destacados" data-aos="fade-right">
                    <img src="assets/destacados/iphone14_card.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">IPHONE 14 PRO MAX</h5>
                        <p class="card-text">Lo último en tecnología Apple. Pantalla Super Retina XDR. Hasta 29 horas de
                            reproducción de video y muchas más utilidades.</p>
                ...
                <div class="card shadow p-3 mb-3 rounded destacados" data-aos="fade-right">
                    <img src="assets/destacados/notebook_card.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">NOTEBOOK BOOK 3</h5>
                        <p class="card-text">Galaxy Book 3 llega con el hardware más poderoso, y tiene la mejor
                            integración con el resto del ecosistema de la marca.</p>
                ...
                <div class="card shadow p-3 mb-3 rounded destacados" data-aos="fade-right">
                    <img src="assets/destacados/monitor_card.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">MONITOR GAMING</h5>
                        <p class="card-text">Es un monitor de 55" con un panel curvo. Resolución 4K, refresco de 165 Hz
                            y se puede configurar en vertical u horizontal.</p>
        ...
        <section class="suscripcion " id="contacto">
            ...
            <form action="" method="" class="my-3 needs-validation was-validated" novalidate>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <div class="invalid-feedback">
                        Complete su email correctamente.
                    </div>
                </div>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="inlineRadio1">Por redes</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" required>
                    <label class="form-check-label" for="inlineRadio2">Por contactos</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option3" required>
                    <label class="form-check-label" for="inlineRadio2">Por la web</label>
                    <div class="invalid-feedback">Elija una opción</div>
                </div>
                <div><button type="submit" class="btn btn-success my-2" id="enviar">Suscribirse</button></div>
            </form>
        </section>
    </main>
        ...
        <div class="container-fluid text-center footer">
            <div class="row mx-md-5">
                ...
                <div class="col-sm-3 text-sm-start my-2">
                    <h4>Contacto</h4>
                    <div>
                        <a href="#" class="ubicacion" data-bs-toggle="modal" data-bs-target="#exampleModal1">Iguazú 333,
                            Parque Patricios
                        </a>
                    </div>
                    <div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <iframe class="img-ubicacion" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3282.5205347918604!2d-58.408952725112016!3d-34.64155485949597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccb0d81a1f483%3A0x170f2295f76c0e6c!2sIguaz%C3%BA%20333%2C%20C1437ETC%20CABA!5e0!3m2!1ses-419!2sar!4v1695339001216!5m2!1ses-419!2sar" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
