...
<header class="bg-dark">
        <div class="row container-fluid">
            <div class="col-md-6 col-auto">
                <a href="#">
                    <img class="icon_codo my-2" src="assets/portada/codo_a_codo.png" title="TiendaBA">
                </a>
            </div>
...
<main class="main-carrito">
    <div class="text-center">
        ...
        <a href="index.jsp">Probá agregar tu primer producto</a>
        <div class="my-4">
    ...
    <div class="container-fluid text-center">
        <div class="row mx-md-5">
            ...
            <div class="col-sm-3 text-sm-start my-2">
                <h4>Contacto</h4>
                <div>
                    <a href="#" class="ubicacion" data-bs-toggle="modal" data-bs-target="#exampleModal2">Iguazú 333,
                        Parque Patricios
                    </a>
                </div>
