...
<head>
 ...
 <body class="bg-image" 
     style="background-image: url('assets/portada/smart_portada.jpeg');
      ...
      ;
        ...
        %>
       <div class="container my-2 bg-white p-3 rounded" style="width:60%;">
         ...
         <div class="mb-3" form-group>
        		...
        		<div class="d-flex flex-sm-row flex-column justify-content-between align-items-center">
                    ...
                    <button class="btn btn-success" type="button" id="boton" style="width:100%">Agregar imagen</button>
                 </div>   
                    <input type="text" class="form-control" name="txtImagen" value="<%=bean.getImagen()%>" id=up-img>
                </div>
            
             <div class="mb-3" form-group>
                    <label>Id del producto</label>
                    <input type="text" class="form-control" name="cod" value="<%=bean.getIdProducto()%>" readonly="readonly">
                </div>
            
                <div class="mb-3" form-group>
                    <label>Descripción</label>
                    <input type="text" class="form-control" name="txtDescripcion" value="<%=bean.getDescripcion()%>">
                </div>
                
                 <div class="mb-3" form-group>
                    <label>Precio</label>
                    <input type="text" class="form-control" name="txtPrecio" value="<%=bean.getPrecio()%>">
                </div>
                
                  <div class="mb-3" form-group>
                    <label>Cantidad</label>
                    <input type="text" class="form-control" name="txtStock" value="<%=bean.getCantidad()%>">
                </div>

                <div class="text-center" form-group>
                     <input type="hidden" name="accion"/>
                    <input class="btn btn-primary" type="button" name="btn" value="Editar producto" onclick="enviarDatos();">
                    </div>
                </form>
