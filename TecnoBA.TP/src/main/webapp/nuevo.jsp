...
<head>
 ...
 <body class="bg-image" 
     style="background-image: url('assets/portada/celulares_portada.jpg');
  ...
  <%
    ...
    <div class="container mt-3 bg-white p-3 rounded" style="width:60%;">
				 <h2 class="text-center mb-4">Nuevo Producto</h2>

           <form action="nuevo.jsp" class="formContact">
        		...
        		<div class="d-flex flex-sm-row flex-column justify-content-between align-items-center">
                    ...
                    <input type="text" class="form-control" name="txtImagen" placeholder="Espere url de la imagen" id=up-img>
                </div>
            
                <div class="mb-3" form-group>
                    <label>Descripción</label>
                    <input type="text" class="form-control" name="txtDescripcion" placeholder="Ingrese la descripción">
                </div>
                
                 <div class="mb-3" form-group>
                    <label>Precio</label>
                    <input type="text" class="form-control" name="txtPrecio" placeholder="Ingrese el precio" >
                </div>
                
                  <div class="mb-3" form-group>
                    <label>Cantidad</label>
                    <input type="text" class="form-control" name="txtStock" placeholder="Ingrese la cantidad" >
                </div>
                ...
                <div class="text-center" form-group>
                    ...
                    <input class="btn btn-primary" type="button" name="btn" value="Agregar producto" onclick="enviarDatos();">
                    </div>
              </form>
